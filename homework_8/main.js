...
const users = [
    new User(1, 'Ivan', 'Karpenko', 'feden@gmail.com', '+380974544231'),
    new User(2, 'Tamara', 'Renko', 'tamara@gmail.com', '+380974544231'),
    new User(3, 'Bohdan', 'Shevchenko', 'andriy@gmail.com', '+3809745631'),
...
const clients = [
    new Client(1, 'Ivan', 'Karpenko', 'feden@gmail.com', '+380974544231', [
        'apple', 'bread', 'milk', 'malone', 'bear'
    ]),
    new Client(2, 'Tamara', 'Renko', 'tamara@gmail.com', '+380974544231', [
        'apple', 'bread', 'milk',
    ]),
    new Client(3, 'Bohdan', 'Shevchenko', 'andriy@gmail.com', '+3809745631', [
        'apple', 'bread'
    ]),
